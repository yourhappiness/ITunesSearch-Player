...
final class SearchView: UIView {
    ...
    let searchChoiceControl: UISegmentedControl = {
      let control = UISegmentedControl(items: [SearchMode.app.rawValue, SearchMode.songs.rawValue])
    ...
    private func configureUI() {
        ...
        self.addSubview(self.searchChoiceControl)
        self.addSearchBar()
        self.addTableView()
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            self.searchChoiceControl.topAnchor.constraint(equalTo: self.topAnchor, constant: 8.0),
            self.searchChoiceControl.centerXAnchor.constraint(equalTo: self.centerXAnchor),
          
          
            self.searchBar.topAnchor.constraint(equalTo: self.searchChoiceControl.bottomAnchor,
                                                constant: 8.0),
            ...
            self.emptyResultLabel.topAnchor.constraint(equalTo: self.emptyResultView.topAnchor,
                                                       constant: 12.0),
